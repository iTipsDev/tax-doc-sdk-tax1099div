...
import irs.fdxtax641.jsonserializers.Tax1099DivSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Div;
import org.taxdataexchange.core.pdfbuilders.Tax1099DivPdfBuilder;
...
public class Tax1099DivDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Div obj = Map2Tax1099Div.generate( row );
        {
            String asJson = Tax1099DivSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Div.csv";
        ...
        String outputFileName = "Tax1099Div.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099DivDocumentGenerator generator = new Tax1099DivDocumentGenerator( );
