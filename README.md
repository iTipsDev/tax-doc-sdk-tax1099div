# tax-doc-sdk-tax1099div

Software development kit to generate IRS Form 1099-DIV as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Div.sample.png" width="850"/>
